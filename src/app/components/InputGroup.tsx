            ...
            <div className="p-5">
                <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                        {icon ? (
                            <div className="text-gray-400 group-hover:text-blue-500 transition-colors duration-200">{icon}</div>
                        ) : (
                ...
                <textarea
                    className="w-full px-3 py-2 bg-transparent border-none text-sm min-h-[120px] resize-none focus:ring-0 placeholder-gray-400 text-gray-900 font-sans leading-relaxed"
